...
export default function SubEmpresas() {
  ...
  type SubEmpresa = { a: string; b: string };
  const [array, setArray] = useState<SubEmpresa[]>([]);

  function addSubEmpresa(nome: string, cnpj: string) {
    setArray([
      ...array,
      { a: nome, b: cnpj },
    ]);
  ...
  return (
    <div>
      <div className="justify-self-start text-left mt-2 p-5 w-full">
        <div className="flex flex-row gap-4 items-center">
          <div className="flex-1">
            <h2 className="text-5xl font-bold">Sub-Empresas</h2>
          ...
          <Dialog>
            <form>
              <DialogTrigger asChild>
                <Button variant="outline" className="mt-1"><PlusCircle/>Adicionar Sub-Empresa</Button>
              </DialogTrigger>
              <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                  <DialogTitle>Adicionar Sub-Empresa</DialogTitle>
                  <DialogDescription>
                    Adicione uma nova Sub-Empresa ao sistema.
                  </DialogDescription>
                </DialogHeader>
                ...
                <DialogFooter>
                  ...
                  <Button type="button" onClick={() => addSubEmpresa(nameValue, cnpjValue)}>Salvar</Button>
                </DialogFooter>
              </DialogContent>
            </form>
          </Dialog>
      ...
      <div className="flex-1 p-5">
        <Table>
          <TableCaption>Lista de Sub-Empresas registradas no sistema.</TableCaption>
          <TableHeader>
            <TableRow>
